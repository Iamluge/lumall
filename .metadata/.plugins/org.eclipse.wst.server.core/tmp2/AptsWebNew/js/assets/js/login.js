...
var Login = function() {
	...
	return {
		...
		init : function() {
			...
			initSignInUpSwitcher(); // Handle sign in and sign up specific
									// things
			...
			initForgotPasswordValidation(); // Validation for the
											// Password-Forgotten-Widget

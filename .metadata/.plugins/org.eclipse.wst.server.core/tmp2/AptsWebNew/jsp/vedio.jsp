...
<div class="vedio-list">
		<c:forEach items="${resourceUrlList}" var="res">
				...
				<a onClick="playVedio('${res.urlContext}','${res.urlId}')"
					onMouseOver="this.style.color='#000'"
					onMouseOut="this.style.color='#999'">${res.description}</a>
	
		</c:forEach>
</div>
<div id="video" align="center" style="width:600px;height:400px;"><div id="a1"></div></div>
<script type="text/javascript">
function playVedio(vedio,id){
var url = "http://localhost:8080/file/"+vedio;
var flashvars={
	f:url,//视频地址
...
var attributes={id:id,name:'ckplayer_a1',menu:'false'};

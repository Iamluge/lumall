...
Ext.Ajax.request({
	...
	success : function(extMessage){
		...
		if(json.successOrFalse == "false"){
			...
			if(sessionCompany.trademark != "undefined" && sessionCompany.trademark != null && sessionCompany.trademark != ""){
				trademark = '<img src="http://localhost:8080/file/'+sessionCompany.trademark+'" width ="175" height="150" align="center"/>' ;
			}else{
				trademark = "";
			}
			if(sessionCompany.headImage != "undefined" && sessionCompany.headImage != null && sessionCompany.headImage != ""){
				headImage = '<img src="http://localhost:8080/file/'+sessionCompany.headImage+'" width ="100%" height="60" align="center"/>' ;
			}else{
				headImage = "";
			}

...
public class AliyunOSSClientUtil {
	...
	// Logger.getLogger(AliyunOSSClientUtil.class);
	// 阿里云API的内或外网域名
	 ...
	 */
	public static String uploadObject2OSS(Long fileSize,OSSClient ossClient,InputStream is,String fileName, String bucketName, String folder) {
